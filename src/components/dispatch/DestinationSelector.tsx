...
interface DestinationOption { value: string; label: string; }
interface DestinationSelectorProps { value: string; onChange: (value: string) => void; availableDestinations?: DestinationOption[]; }
  ...
  return (
    <div className="space-y-2">
      ...
      <Select value={value} onValueChange={onChange}>
        <SelectTrigger className="bg-background"><SelectValue placeholder="Select destination" /></SelectTrigger>
        <SelectContent>
